...
import com.blamejared.primalchests.common.blocks.tileentities.AdvancedPrimalChestTileEntity;
import com.blamejared.primalchests.common.blocks.tileentities.TileEntityRegister;
...
public class AdvancedPrimalChestBlock extends HorizontalBlock implements IWaterLoggable {

    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

    public AdvancedPrimalChestBlock() {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return TileEntityRegister.ADVANCED_PRIMAL_CHEST_TILE_ENTITY.get().create();
    }
    ...
    public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
        ...
        if (!worldIn.isClientSide()) {
            ...
            if (te instanceof AdvancedPrimalChestTileEntity) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (AdvancedPrimalChestTileEntity) te, pos);
