...
public class RenderTileEntityPrimalChest extends TileEntitySpecialRenderer<TileEntityPrimalChest> {
    ...
    @Override
    public void render(TileEntityPrimalChest te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if(destroyStage >= 0) {
            ...
            this.bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/models/primal_chest.png"));
        }
