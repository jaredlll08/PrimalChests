...
public class BlockPrimalChestAdvanced extends Block implements IHasGui {
    ...
    public Gui getClientGuiElement(int id, EntityPlayer player, World world, BlockPos blockPos) {
        return new GuiPrimalChestAdvanced(player.inventory, (TileEntityPrimalChestAdvanced) world.getTileEntity(blockPos));
    }
    
    @Override
    public Container getServerGuiElement(int id, EntityPlayer player, World world, BlockPos blockPos) {
        return new ContainerPrimalChestAdvanced(player.inventory, (TileEntityPrimalChestAdvanced) world.getTileEntity(blockPos));
    }
}
